...
\subparagraph{Room 204}
\subparagraph{Mondays, Wednesdays, \& Fridays, 10:40 am--12:30 pm}
\subparagraph{\url{https://emfink.net/CivPro}}
\vspace{1em}
...
\tightlist
\item
  Foundations of Civil Procedure, \emph{Casebook} Chap. 1
\end{itemize}
...
\tightlist
\item
  Permissive Joinder of Claims \& Parties, \emph{Casebook} Chap. 2, §§
  2.1 \& 2.2
\end{itemize}
...
\tightlist
\item
  Counterclaims, \emph{Casebook} Chap. 2, § 2.3
\end{itemize}
...
\tightlist
\item
  Crossclaims, \emph{Casebook} § Chap. 2, 2.4
\end{itemize}
...
\tightlist
\item
  Third-Party Defendants \& Claims, \emph{Casebook} Chap. 2, § 2.5
\end{itemize}
...
\tightlist
\item
  Constitutional Limits: Due Process, \emph{Casebook} Chap. 3, § 3.1
\end{itemize}
...
\tightlist
\item
  Specific Jurisdiction, \emph{Casebook} Chap. 3, § 3.2
\end{itemize}
...
\tightlist
\item
  General Jurisdiction, \emph{Casebook} Chap. 3, § 3.3
\end{itemize}
...
\tightlist
\item
  Consent; Long-Arm Statutes, \emph{Casebook} Chap. 3, §§ 3.4 \& 3.5
\end{itemize}
...
\paragraph{Monday, October 5 \& Wednesday, October
7}\label{monday-october-5-wednesday-october-7}

\begin{itemize}
\tightlist
\item
  Constitutinal Foundation; Federal Question Jurisdiction,
  \emph{Casebook} Chap. 4, §§ 4.1 \& 4.2
\end{itemize}

\paragraph{Friday, October 9 \& Monday, October
12}\label{friday-october-9-monday-october-12}

\begin{itemize}
\tightlist
\item
  Diversity Jurisdiction, \emph{Casebook} Chap. 4, § 4.3
\end{itemize}

\paragraph{Wednesday, October 14 \& Monday, October
19}\label{wednesday-october-14-monday-october-19}

\begin{itemize}
\tightlist
\item
  Supplemental Jurisdiction, \emph{Casebook} Chap. 4, § 4.4
\end{itemize}
...
\tightlist
\item
  The Rules of Decision Act, \emph{Casebook} Chap. 5, § 5.1
\end{itemize}

\paragraph{Monday, October 26 \& Wednesday, October
28}\label{monday-october-26-wednesday-october-28}

\begin{itemize}
\tightlist
\item
  The Rules Enabling Act; Synthesis, \emph{Casebook} Chap. 5, §§ 5.2 \&
  5.3
\end{itemize}
...
\tightlist
\item
  Pleading Under the Federal Rules, \emph{Casebook} Chap. 6, §§ 6.1
\end{itemize}
...
\tightlist
\item
  Assessing the Sufficiency of a Claim, \emph{Casebook} Chap. 6, §§ 6.2
\end{itemize}
...
\tightlist
\item
  Answers \& Defenses \emph{Casebook} Chap. 6, § 6.3
\end{itemize}
...
\tightlist
\item
  Truthfulness and Good Faith, \emph{Casebook} Chap. 6, § 6.4
\end{itemize}
...
\paragraph{Wednesday, November 11 \& Friday, November
13}\label{wednesday-november-11-friday-november-13}

\begin{itemize}
\tightlist
\item
  Full Faith \& Credit; Claim Preclusion, \emph{Casebook} Chap. 7, §§
  7.1 \& 7.2
\end{itemize}

\paragraph{Monday, November 16 \& Wednesday, November
18}\label{monday-november-16-wednesday-november-18}

\begin{itemize}
\tightlist
\item
  Issue Preclusion, \emph{Casebook} Chap. 7, § 7.3
\end{itemize}
