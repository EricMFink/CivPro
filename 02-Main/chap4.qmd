...
Article III of the Constitution identifies certain types of cases over which federal courts may exercise jurisdiction. Within the bounds set by Article III, Congress may authorize federal courts to exercise some or all of that jurisdiction. Some statutes authorize the exercise of jurisdiction over broad categories of cases, such as those arising under federal law, 28 U.S.C. § 1331, and those between citizens of different states, 28 U.S.C. § 1332. Provisions authorizing federal jurisdiction are also sometimes included in statutes establishing particular causes of action, e.g. 29 U.S. Code § 185 (authorizing federal jurisdiction over suits for violation of collective bargaining agreements under the National Labor Relations Act).

Except for certain matters over which federal jurisdiction is exclusive,[^exclusive_jurisdiction] state courts generally have concurrent jurisdiction, giving plaintiffs a choice of forum. If a plaintiff opts to sue in state court, the defendant may (provided federal subject matter jurisdiction and other conditions are satisfied) override that choice by removing the action to federal court.[^removal] The conditions and procedures for removal are governed by federal statute. 28 U.S.C. §§ 1441 et seq.

[^exclusive_jurisdiction]: Notable examples of exclusive federal jurisdiction include suits between states, suits involving ambassadors or other high public officials, suits in admiralty (the body of law governing maritime claims), and suits arising under certain areas of federal law such as bankruptcy, intellectual property (patents, copyrights, & trademarks), antitrust, securities, and labor-management relations. Sometimes, as with antitrust and trademarks, state law may provide additional or alternative causes of action, over which state courts have jurisdiction. In a few areas, such as patents and labor-management relations, federal law completely preempts state law, making federal court the sole available forum.

[^removal]: Removal is a one-way street. If a plaintiff files a suit in federal court, the defendant may not "remove" or "remand" the case to state court. The only option is to move for dismissal for lack of federal subject matter jurisdiction under Fed. R. Civ. P. Rule 12(b)(1). Such dismissals are usually "without prejudice", meaning the plaintiff may refile the suit in state court. If federal subject matter jurisdiction is satisfied, the case remains in federal court.
...
#### @LouisvilleNashvilleCoMottley_US1908
...
#### @GrableSonsMetalProducts_US2005
...
#### @OttawaTownshipBoardTrustees_NDOhio2017
...
#### @OttawaTownshipBoardTrustees_NDOhio2017a
...
#### @CompleteBusinessSolutionsGroup_EDPa2020
...
#### @JonesFordMotorCredit_2ndCir2004
...
#### @GinwrightExeterFinanceCorp_DMd2017
...
#### @ExxonMobilCorpAllapattah_US2005
...
The Court interpreted § 1367 to permit supplemental jurisdiction over claims by multiple plaintiffs against the same defendant, provided complete diversity is preserved, without requiring each plaintiff to satisfy the statutory amount in controversy under § 1332 (as long as at least one does). What about the inverse: Claims by one plaintiff against multiple defendants?

Consider this example: 

- P (a citizen of NC), D1 (a citizen of DC), & D2 (also a citizen of SC) are parties to a contract. 
- P sues D1 and D2 for breach, seeking $80,000 against D1 and $50,000 against D2. 
- D1 asserts a crossclaim against D2 for breach of the same contract, seeking $30,000. 

![Claims by a single plaintiff against multiple defendants under §1367(b)](..img/1367b-co-defendants.png){width=60%}

The court would have diversity jurisdiction (§ 1332) over P's claim against D1 standing on its own. Joinder of D2 does not destroy complete diversity. But the claim against D2 does not satisfy § 1332's amount in controversy requirement. 

1. May the court exercise supplemental jurisdiction over P's claim against D2? Does § 1367(b) give a clear answer? 
2. What about D1's crossclaim against D2 (assuming D2 is properly joined and the court has jurisdiction on same basis over P's claim against D2)? 
