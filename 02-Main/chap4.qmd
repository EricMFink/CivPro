...
The subject matter jurisdiction of the federal courts is governed by the Constitution (which defines the permissible extent of jurisdiction) and statutes (which authorize the exercise of some, but not all, of the jurisdiction permitted under the Constitution). Except for certain matters over which federal jurisdiction is exclusive,[^exclusive_jurisdiction] state courts generally have concurrent jurisdiction, giving plaintiffs a choice of forum. If a plaintiff opts to sue in state court, the defendant may (provided federal subject matter jurisdiction and other conditions are satisfied) override that choice by removing the action to federal court. The conditions and procedures for removal are governed by federal statute. 28 U.S.C. §§ 1441 et seq.[^removal]

[^exclusive_jurisdiction]: Notable examples of exclusive federal jurisdiction include suits between states, suits involving ambassadors or other high public officials, suits in admiralty (the body of law governing maritime claims), and claims arising under federal bankruptcy, intellectual property (patents, copyrights, & trademarks), antitrust, securities, and labor-management relations laws. Sometimes, as with antitrust and trademarks, state law may also provide an additional or alternative cause of action. In a few areas, such as patents and labor-management relations, federal law completely preempts any claims under state law. 
...
#### @HanksCoan_MDNC1999 Hanks v Coan (M.D.N.C. 1999) 
