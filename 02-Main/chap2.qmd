...
_United Mine Workers of America v. Gibbs_.
...
Third, _res judicata_ [_Res judicata_ (claim preclusion) is covered in Chap. 7.]{.aside} would not bar a subsequent suit on the breach of contract counterclaim. "The preclusive effect of a federal-court judgment is determined by federal common law." An action is precluded when:
...
![Indemnification and Contribution](../img/indemnification-contribution.png){width=66%}
...
3. Assume instead that Claypool sues only Driftwood. May Gottlieb intervene as a plaintiff to assert a claim against Driftwood for failure to sign Lasparri to a contract with the Opera Company? 
...
![Parties & Claims in Claypool v. Gottlieb](../img/Claypool.png){width=75%}
