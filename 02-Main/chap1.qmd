...
### Franz Kafka, _Before the Law_ (1915)
...
![Franz Kafka, Mann zwischen Gittern](../img/Mann_zwischen_Gittern.png){width=33%}

### William Felstiner, et al, _The Emergence & Transformation of Disputes_ (1980)
...
### Administrative Office of the U.S. Courts, _Understanding the Federal Courts_
...
![Federal District Courts & Appellate Circuits](../img/FedCourtsMap.png){width=66%}
...
Although the details of the complex web of federal jurisdiction that Congress has given the federal courts is beyond the scope of this brief guide,[Federal subject matter jurisdiction is covered in Chapter 3]{.aside} it is important to understand that there are two main sources of the cases coming before the federal courts: "federal question" jurisdiction and "diversity" jurisdiction.
...
![Stages of a Civil Suit, part 1](../img/CivilAction1.png){width=60%}
...
![Stages of a Civil Suit, part 2](../img/CivilAction2.png){width=60%}
