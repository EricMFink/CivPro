...
- (b\) _Time to File a Motion._ Unless a different time is set by local rule or the court orders otherwise, a party may file a motion for summary judgment at any time until 30 days after the close of all discovery. 
- (c\) Procedures.
...
- _(1\) Initial Disclosure._
	- _(A\) In General. Except as exempted by Rule 26(a)(1)(B) or as otherwise stipulated or ordered by the court, a party must, without awaiting a discovery request, provide to the other parties:_
		- _(i\) the name and, if known, the address and telephone number of each individual likely to have discoverable information—along with the subjects of that information—that the disclosing party may use to support its claims or defenses, unless the use would be solely for impeachment;_
		- _(ii\) a copy—or a description by category and location—of all documents, electronically stored information, and tangible things that the disclosing party has in its possession, custody, or control and may use to support its claims or defenses, unless the use would be solely for impeachment;_
		- _(iii\) a computation of each category of damages claimed by the disclosing party—who must also make available for inspection and copying as under Rule 34 the documents or other evidentiary material, unless privileged or protected from disclosure, on which each computation is based, including materials bearing on the nature and extent of injuries suffered; and_
		- _(iv\) for inspection and copying as under Rule 34, any insurance agreement under which an insurance business may be liable to satisfy all or part of a possible judgment in the action or to indemnify or reimburse for payments made to satisfy the judgment._
- _(2\) Disclosure of Expert Testimony._
	- _(A\) In General. In addition to the disclosures required by Rule 26(a)(1), a party must disclose to the other parties the identity of any witness it may use at trial to present evidence under Federal Rule of Evidence 702, 703, or 705._
- _(3\) Pretrial Disclosures._
	- _(A\) In General. In addition to the disclosures required by Rule 26(a)(1) and (2), a party must provide to the other parties and promptly file the following information about the evidence that it may present at trial other than solely for impeachment:_
		- _(i\) the name and, if not previously provided, the address and telephone number of each witness—separately identifying those the party expects to present and those it may call if the need arises;_
		- _(ii\) the designation of those witnesses whose testimony the party expects to present by deposition and, if not taken stenographically, a transcript of the pertinent parts of the deposition; and_
		- _(iii\) an identification of each document or other exhibit, including summaries of other evidence—separately identifying those items the party expects to offer and those it may offer if the need arises._
...
> _Unless otherwise limited by court order, the scope of discovery is as follows: Parties may obtain discovery regarding any nonprivileged matter that is relevant to any party's claim or defense and proportional to the needs of the case, considering the importance of the issues at stake in the action, the amount in controversy, the parties’ relative access to relevant information, the parties’ resources, the importance of the discovery in resolving the issues, and whether the burden or expense of the proposed discovery outweighs its likely benefit. Information within this scope of discovery need not be admissible in evidence to be discoverable._

:::

Rule 26(b) also sets certain limits on discovery, including "information ... subject to a claim of privilege or of protection as trial-preparation material". Rule 26(d) governs the timing and sequence of requests. 

The court may impose sanctions on parties for failure to make required disclosures or cooperate in the discovery process. [Rule 37](https://www.law.cornell.edu/rules/frcp/rule_37)
...
#### @CraneCityArlingtonTexas_5thCir2022
...
[Facts and Proceedings]{.casesection}
...
[I. Legal Stgandard]{.casesection}

[A. Summary Judgment]{.casesubsection}
...
_B. Qualified Immunity_

The Supreme Court has articulated a two-part question for any qualified immunity determination: First, “\[t\]aken in the light most favorable to the party asserting the injury, do the facts alleged show the officer's conduct violated a constitutional right?” ![](https://i1.next.westlaw.com/StaticContent_2511.2.2003/images/th_indigo/delivery/flag_red_striped_small.png?ignoreDeliveryNewLine)[_Saucier v. Katz_, 533 U.S. 194, 201, 121 S.Ct. 2151, 150 L.Ed.2d 272 (2001)](https://1.next.westlaw.com/Link/Document/FullText?findType=Y&serNum=2001518729&pubNum=0000708&originatingDoc=I3aa19850105a11e8b7ce8230219a322d&refType=RP&originationContext=document&transitionType=DocumentItem&ppcid=14704008c3bf41fba62e60d24de647df&contextData=(sc.Default)). Second, we ask “\[w\]hether the allegedly violated constitutional rights were clearly established at the time of the incident; and, if so, whether the conduct of the defendants was objectively unreasonable in light of that then clearly established law.” ![](https://i1.next.westlaw.com/StaticContent_2511.2.2003/images/th_indigo/delivery/flag_yellow_small.png?ignoreDeliveryNewLine)[_Tarver v. City of Edna_, 410 F.3d 745, 750 (5th Cir. 2005)](https://1.next.westlaw.com/Link/Document/FullText?findType=Y&serNum=2006664131&pubNum=0000506&originatingDoc=I3aa19850105a11e8b7ce8230219a322d&refType=RP&fi=co_pp_sp_506_750&originationContext=document&transitionType=DocumentItem&ppcid=14704008c3bf41fba62e60d24de647df&contextData=(sc.Default)#co_pp_sp_506_750) (internal quotation marks omitted). An official's qualified immunity defense prevails “\[i\]f no constitutional right would have been violated were the allegations established.” ![](https://i1.next.westlaw.com/StaticContent_2511.2.2003/images/th_indigo/delivery/flag_red_striped_small.png?ignoreDeliveryNewLine)[_Saucier_, 533 U.S. at 201, 121 S.Ct. 2151](https://1.next.westlaw.com/Link/Document/FullText?findType=Y&serNum=2001518729&pubNum=0000708&originatingDoc=I3aa19850105a11e8b7ce8230219a322d&refType=RP&originationContext=document&transitionType=DocumentItem&ppcid=14704008c3bf41fba62e60d24de647df&contextData=(sc.Default)).

“The Plaintiff bears the burden of proving that a government official is not entitled to qualified immunity.” ![](https://i1.next.westlaw.com/StaticContent_2511.2.2003/images/th_indigo/delivery/flag_yellow_small.png?ignoreDeliveryNewLine)[_Michalik v. Hermann_, 422 F.3d 252, 258 (5th Cir. 2005)](https://1.next.westlaw.com/Link/Document/FullText?findType=Y&serNum=2007143793&pubNum=0000506&originatingDoc=I3aa19850105a11e8b7ce8230219a322d&refType=RP&fi=co_pp_sp_506_258&originationContext=document&transitionType=DocumentItem&ppcid=14704008c3bf41fba62e60d24de647df&contextData=(sc.Default)#co_pp_sp_506_258). This burden is not easy to meet because qualified immunity “provides ample protection to all but the plainly incompetent or those who knowingly violated the law.” ![](https://i1.next.westlaw.com/StaticContent_2511.2.2003/images/th_indigo/delivery/flag_yellow_small.png?ignoreDeliveryNewLine)[_Malley v. Briggs_, 475 U.S. 335, 341, 106 S.Ct. 1092, 89 L.Ed.2d 271 (1986)](https://1.next.westlaw.com/Link/Document/FullText?findType=Y&serNum=1986111440&pubNum=0000708&originatingDoc=I3aa19850105a11e8b7ce8230219a322d&refType=RP&originationContext=document&transitionType=DocumentItem&ppcid=14704008c3bf41fba62e60d24de647df&contextData=(sc.Default)).

[B. Qualified Immunity]{.casesubsection}

The Supreme Court has articulated a two-part question for any qualified immunity determination: First, “taken in the light most favorable to the party asserting the injury, do the facts alleged show the officer's conduct violated a constitutional right?” Second, we ask “whether the allegedly violated constitutional rights were clearly established at the time of the incident; and, if so, whether the conduct of the defendants was objectively unreasonable in light of that then clearly established law.” An official's qualified immunity defense prevails “if no constitutional right would have been violated were the allegations established.” 

“The Plaintiff bears the burden of proving that a government official is not entitled to qualified immunity.” This burden is not easy to meet because qualified immunity “provides ample protection to all but the plainly incompetent or those who knowingly violated the law.”

[C. Fourteenth Amendment Racial Profiling]{.casesection}
...
[II. Lack of Evidence of Fourteenth Amendment Violation]{.casesection}

The district court concluded that Montgomery and Stout “have not presented any evidence to support \[their\] claim” that Officer Vincent's decision to detain them was “at least partially based on their race.” The district court further concluded that Montgomery and Stout “have likewise not shown that their race played any role whatsoever in Vincent's formulation of a reasonable suspicion or wrongdoing, or in the actions that were taken by him to dispel that suspicion.”
...
#### @EldenNirvanaLlc_DistCourt2025 Elden v. Nirvana, L.L.C. (C.D.Cal. 2025)

[Background]{.casesection}

In 1991, Spencer Elden, then a four-month-old infant, was photographed naked in a pool for the cover of Nirvana's "Nevermind" music album.[![](../img/nevermind.jpg) "Nevermind" album cover]{.aside} The album cover depicted plaintiff underwater, "grabbing for a dollar bill" on a fishook that had been superimposed onto the photograph. The "Nevermind" album was released in September 1991, and was widely distributed commercially, becoming "a platinum record only months after its release." 
...
[Statement of Facts]{.casesection}
...
[A. The _Dost_ factors.]{.casesubsection}
...
[B. Other Relevant Factors.]{.casesubsection}
