...
\tightlist
\item
  General Jurisdiction, \emph{Casebook} § 3.3
\end{itemize}
...
\tightlist
\item
  Consent; Long-Arm Statutes, \emph{Casebook} §§ 3.4 \& 3.5
\end{itemize}
...
\tightlist
\item
  Pleading Under the Federal Rules, \emph{Casebook} §§ 6.1
\end{itemize}
...
\tightlist
\item
  Answers \& Defenses \emph{Casebook} § 6.3
\end{itemize}
...
\tightlist
\item
  Truthfulness and Good Faith, \emph{Casebook} § 6.4
\end{itemize}
...
\tightlist
\item
  Full Faith \& Credit; Claim Preclusion, \emph{Casebook} §§ 7.1 \& 7.2
\end{itemize}
...
\tightlist
\item
  Issue Preclusion, \emph{Casebook} § 7.3
\end{itemize}
