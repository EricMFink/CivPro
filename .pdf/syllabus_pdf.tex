...
\tightlist
\item
  Permissive Joinder of Claims \& Parties, \emph{Casebook}: §§ 2.1 \&
  2.2
\end{itemize}
...
\tightlist
\item
  General Principles \& Claim Preclusion, \emph{Casebook}: §§ 7.1 \& 7.2
\end{itemize}
...
\tightlist
\item
  Standard \& Burden of Production, \emph{Casebook}: §§ 8.1 \& 8.2
\end{itemize}
